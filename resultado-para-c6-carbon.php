...
<div class="container conteudo">
    ...
    <div class="banner-bg mobile-d-block mb-4 bg-warning fundoLaranja">
        <label class="banner-titulo fonteAzulEscuro">Resultado para<br>C6 Carbon</label>
        ...
        <div class="col-md-9 w-100-tablet">
            ...
            <div>
                ...
                <div class="blocoSearchBlue w-100 text-center">
                    <span class="NunitoWhite700 my-4 zeroAuto d-inline-grid px-5 ms-2-5 text-center">Resultado para C6
                        Carbon</span>
                </div>
                ...
                <div class="left w-100 mb-5 pb-4" style="background: #BFBFBF;">
                    ...
                    <div class="w-100 left py-5 text-center d-grid-mob">
                        <span class="NunitoGrey500-2">Valor a ser gasto:</span>
                        <span class="NunitoBlue700-3 mt-3-mob">&nbsp; R$ 0,00</span>
                    </div>

                    <div class="card border-0 col-md-4 w-47-mob-3-per-2 px-2 zeroAuto pb-3 my-5 w-200">
                        <a class="text-decoration-none">
                            <div class="w-100 text-center mt-2">
                                <img src="images/cartao-azul-1.svg" class="w-120px mt-3 ms-1">

                            </div>
                            <span class="NunitoGray500 pt-2 px-2 w-100 d-block w-100 text-center">Azul</span>
                        </a>
                    </div>
                    ...
                    <div class="w-100">
                        <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
                            ...
                            <span class="NunitoBlue700-3 text-center w-100 py-3">Ganhos de Pontos na Fatura</span>
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left">Valor a ser gasto:</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">R$ 0,00</span>
                                </div>
                            </div>
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left">Esse cartão possui a
                                        pontuação em dólar:</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">0.0</span>
                                </div>
                            </div>
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left">Esse cartão possui a
                                        pontuação em real:</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">0.0 pts / R$</span>
                                </div>
                            </div>
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left">O Cartão possui pontuação
                                        bonificada?</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left">Informe o valor de transferência bonificada?</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2 left pt-1">Nessa fatura você pode ganhar:</span>
                                    <span class="NunitoBlue700-3 float-end text-center-mobile-2">0.0 pts / R$</span>
                                </div>
                            </div>
                ...
                <div class="w-100 left pb-3 d-grid-mob">
                    ...
                    <a class="botaoRedondo1 text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 float-start mb-3 text-center-mobile-2"
                        ...
                        <span class="texto-botao"><img src="images/arrow-right-1.svg"
                                class="transform180 float-start p-1 mobile-d-none" /> &nbsp; Simular novamente</span>
                    </a>
                    ...
                    <a class="botaoRedondo1 bgVerde text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 d-inline-block float-end mb-5 text-center-mobile-2"
                        style="padding-left: 100px !important;padding-right: 100px !important;">
                        <span class="texto-botao">Veja aqui &nbsp; <img src="images/arrow-right-1.svg"
                                class="p-1 mobile-d-none" /></span>
                    </a>

                </div>

                <div class="w-100 left mt-4 bgRosa p-5">
