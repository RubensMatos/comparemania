...
<div class="container conteudo">
    ...
    <div class="banner-bg mobile-d-block mb-4 bg-warning fundoLaranja">
        <label class="banner-titulo fonteAzulEscuro">Simulador de<br>Ganhos</label>
            ...
            <div>
                ...
                <div class="left w-100 mb-5 pb-4" style="background: #BFBFBF;">
                    ...
                    <div class="w-100 left py-5 text-center d-grid-mob">
                        ...
                        <span class="NunitoBlue700-3 mt-3-mob">&nbsp; R$ 1.000,00</span>
                    </div>
                    ...
                    <div class="w-100">
                        <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
                            <span class="NunitoBlue700-3 w-100 text-center pt-3">Cashback</span>
                            <div class="w-100">
                                <hr class="w-95 zeroAuto my-2" />
                            </div>
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 text-center-mobile-2">Melhor opção de cashback:</span>
                                    <span class="NunitoBlue700 float-end text-center-mobile-2">6% de cashback</span>
                                </div>
                            </div>
                            <div class="w-100">
                                <hr class="w-95 zeroAuto my-2" />
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 float-start pt-2 text-center-mobile-2">Nessa compra você pode ganhar:</span>
                                    <span class="NunitoBlue700-3 float-end text-center-mobile-2">R$ 60,00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-100 mt-4 mb-2">
                        <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
                            <span class="NunitoBlue700-3 w-100 text-center pt-3">Pontos / Milhas</span>
                            <div class="w-100">
                                <hr class="w-95 zeroAuto my-2" />
                            </div>
                            <div class="w-100 py-2">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 mt-1 float-start">Selecione a opção de ganho de Pontos/Milhas:</span>
                                    <select class="form-select float-end w-250 mb-1 text-center-mobile zeroAuto-mobile mt-3-mob">
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 float-start pt-2 text-center-mobile-2">Nessa compra você pode ganhar:</span>
                                    <span class="NunitoBlue700-3 float-end text-center-mobile-2">0 pontos</span>
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    <span class="NunitoGrey500-2 float-start pt-2 text-center-mobile-2">Esses pontos podem valer:</span>
                                    <span class="NunitoBlue700-3 float-end text-center-mobile-2">R$ 00,00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-100 text-center left pb-3">
                    <a class="botaoRedondo1 botaoLoader bgVerde text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 d-inline-block"
                        style="padding-left: 100px !important;padding-right: 100px !important;">
                        <span class="texto-botao"><img src="images/arrow-right-1.svg" class="transform180 float-start p-1" /> &nbsp; Simular novamente </span>
                        <div class="d-none loader-botao">
                            <div class="custom-loader"></div>
                        </div>
                    </a>
                </div>

                <div class="w-100 bgRosa left mt-4 p-5">
                    <span class="w-100 left NunitoGray700 mb-2">Observações:</span>
                    <span class="w-100 left NunitoGray700-4">Não são considerados os ganhos de pontos no cartão de crédito.</span>
                </div>
