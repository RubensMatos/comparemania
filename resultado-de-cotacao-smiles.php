                        ...
                        <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
                            ...
                            <div class="w-100">
                                <div class="w-95 zeroAuto py-1 d-grid-mob text-center-mobile-2">
                                    ...
                                    <span
                                        class="NunitoGrey500-2 float-end text-center-mobile-2 pt-2 pe-3">Milheiro: R$ 26,00</span>
                                </div>
                            </div>
                            <div class="w-100">
                                <hr class="w-95 zeroAuto my-2" />
                            ...
                            <div class="w-100">
                            <span class="NunitoGrey500-2 text-center pt-2 w-100 left">Ultima Atualização: 14/09/2023 21:41</span>
                            </div>
                    ...
                    <div class="w-100 mb-5">
                        <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
                            ...
                            <div class="w-100 text-center">
                                <a class="botaoRedondo1 bgVerde text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 d-inline-block mb-5 text-center w-400 mt-4"
    ...
    <div class="card card-1 card-box-shadow w-95 zeroAuto h-auto pb-3">
        ...
        <div class="w-100 text-center">
            <a class="botaoRedondo1 bgVerde text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 d-inline-block mb-5 text-center w-400 mt-4"
                ...
                <div class="w-100 left pb-3 text-center">

                    <a class="botaoRedondo1 text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob d-block mb-3 text-center-mobile-2 w-90 text-center zeroAuto">
                        <span class="texto-botao"><img src="images/arrow-right-1.svg"
                                class="transform180 mobile-d-none" /> &nbsp; Refazer cálculo</span>
                    </a>

                </div>

                <div class="bgRosa w-100 left mt-4 p-5">
