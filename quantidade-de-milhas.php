    ...
    <div class="row my-2">
        ...
        <div class="col-md-9 w-100-tablet">
            ...
            <div>
                ...
                <div class="blocoSearchBlue w-100 text-center d-none">
                    <span class="NunitoWhite700 mt-4 mb-3 zeroAuto d-inline-grid px-5">Descubra as melhores
                        oportunidades de ganhos</span>
                    <div class="w-100 d-grid mb-5 pb-5 pt-2">
                        <div class="input-group mb-3 col-9 pe-3 w-60 w-100-mob ps-2-mob w-80 zeroAuto">
                            <input type="text" class="form-control input-2" placeholder="R$ 0,00" aria-label="R$ 0,00"
                ...
                <div class="blocoSearchBlue w-100">
                    <span class="NunitoWhite700 mt-5 mb-2 zeroAuto d-inline-grid px-5 ms-2-5">Quantidade de milhas</span>

                    <div class="w-100 d-grid pb-5 pt-2">
                        <div class="input-group mb-3 col-9 pe-3 w-60 w-100-mob ps-2-mob w-80 zeroAuto">
                            <input type="text" class="form-control input-2" placeholder="Insira aqui a quantidade">
                        </div>
                    </div>
                </div>

                <div class="left ps-3 w-100 mb-5" style="background: #BFBFBF;">
                ...
                <span class="left NunitoGray500 w-100 text-center mb-3">Última atualização: 14/09/2023 21:41</span>

                <div class="w-100 text-center left pb-2">
                    <a class="botaoRedondo1 botaoLoader bgVerde text-decoration-none cursror pointer px-4 px-0-mob botao-100per-mob px-5 d-inline-block w-350"
                        style="padding-left: 100px !important;padding-right: 100px !important;">
                        <span class="texto-botao">Calcular &nbsp; <img src="images/arrow-right-1.svg"> &nbsp; </span>
                ...
                <div class="col-md-12 mt-5 mobile-d-none">
                    <h3 class="NunitoBlue700-2 bgDark-fonte-1 text-center-mobile pt-5 left w-100">Dicas especiais de quem entende do
                        assunto <a
